...
multiplicity. 25 of
36 configurations pass against a pre-registered floor
of 18; the rest are marked `TOO_EASY` and
...
identity coverage is 0.8965 [0.8759, 0.9159] against
AMLworld's 0.8058 [0.7627, 0.8499] — it fragments *less*,
...
fell from 1,835 to 1,917 repository-wide, held by a ledger
...
which is 0.2111 — survived that way, further down the
...
- **Not measured at adequate `n` on AMLworld.** 18
...
- **Not a measurement of the AI component's judgment.** The drafted path has
  attempted **0 drafts** — no model key is
